...
public class XMLCryptoTest {
	...
	/**
	 * Example of how to insert and retrieve cipher data to and from XML, using
	 * base 64 encoding to represent ciphered data as text
	 * 
	 * @throws Exception
	 *             because test is not concerned with exception handling
	 */
	@Test
	public void testXMLCrypto() throws Exception {
		System.out.print("TEST ");
		System.out.print(SYM_CIPHER);
		System.out.println(" cryptography with XML (textual) data");

		System.out.print("XML text: ");
		...
		System.out.print("XML document contents: ");
		...
		System.out.print("XML document with new body: ");
		transformer.transform(new DOMSource(xmlDocument), new StreamResult(System.out));
		System.out.println();
